...
public class OvalSprite extends Sprite {
     ...
     * width and height
     */
    public OvalSprite(int x, int y, int width, int height) {
        super();
     ...
     */
    public OvalSprite(int x, int y, int width, int height, Sprite parentSprite) {
        super(parentSprite);
        this.initialize(x, y, width, height);
    }
    ...
    public void initialize(int x, int y, int width, int height) {
        oval = new Ellipse2D.Double(0, 0, width, height);
        this.width = width;
        this.height = height;
        anchorX = x;
        anchorY = y;
